 ...
 * @author USER
 */
public class Purches_Pyment extends javax.swing.JInternalFrame {

    Connection con;
    PreparedStatement post;
    ResultSet result;

    public Purches_Pyment() {
        initComponents();
        con = Connect.conect();
    }
    ...
    public void Insert() {
        try {
            ...
            String query = "INSERT INTO `purches_pyment` (`Invoice_No`,`Entry_Date`,`Amount`,`Pyment_Date`,`Paid_Amount`,`Due_Amount`) VALUES ()";
    ...
    public void Update() {
        try {
           String query ="UPDATE `purches_pyment` SET `Entry_Date` ='',`Amount`='',`Pyment_Date`='',`Paid_Amount`='',`Due_Amount`='' WHERE `Invoice_No` =''"; 
        } catch (Exception e) {
        }
    }
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(jDateChooser1, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 220, Short.MAX_VALUE)
        ...
        kGradientPanel1Layout.setVerticalGroup(
            ...
            .addGroup(kGradientPanel1Layout.createSequentialGroup()
                ...
                .addGroup(kGradientPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE, false)
                    .addComponent(kButton3, javax.swing.GroupLayout.DEFAULT_SIZE, 36, Short.MAX_VALUE)
    ...
    private void kButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_kButton2ActionPerformed
        ...
        jComboBox1.setToolTipText("Invoice No");
