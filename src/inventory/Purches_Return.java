 ...
 * @author USER
 */
public class Purches_Return extends javax.swing.JInternalFrame {

    Connection con;
    PreparedStatement post;
    ResultSet result;

    public Purches_Return() {
        initComponents();
        con = Connect.conect();
    }
    ...
    public void Insert() {
        try {
            ...
            String query = "INSERT INTO `purches_return` (`Return_Id`,`Return_Invoice`,`Date`,`Product_Name`,`Quantity`,`Total_Amount`,`Type`,`Discount`,`Net_Total`) "
                    + "VALUES()";
    ...
    public void Update() {
        try {
            String query = "UPDATE `purches_return` SET `Return_Invoice`='',`Date`='',`Product_Name`='',`Quantity`='',`Total_Amount`='',`Type`='', `Discount`='',`Net_Total`='' WHERE `Return_Id`=''";
            post = con.prepareStatement(query);
            post.execute();
    ...
    public void Delete() {
        try {
            String query = "DELETE FROM `purches_return` WHERE `Return_Id`=''";
            post = con.prepareStatement(query);
            post.execute();
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Select Purches Invoice No" }));
